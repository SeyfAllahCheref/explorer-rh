                ...
                <form:form  modelAttribute="candidat" commandName="candidat"
                    ...
                    <div class="form-inline">
                        ...
                        <input name="name" type="text"
                                    ...
                                    <div class="form-group">
                        <label for="firstName">
                           <!--  <span class="glyphicon glyphicon-user"></span> --> FirstName: 
                        </label>
                        <input name="firstName" type="text"
                                  ...
                                  <div class="form-group"> 
                         <label class="file" for="cv">
                            <!--  <span class="glyphicon glyphicon-user"></span> -->cv: 
                        </label>
                        ...
                        <label for="photo">
                            <!--  <span class="glyphicon glyphicon-user"></span> -->Photo: 
                        </label>
                        <input name="photo" type="file"
                                ...
                                <div class="form-group">
                       <label for="niveau">
                           <!--  <span class="glyphicon glyphicon-user"></span> -->niveau: 
                        </label>
                        <input name="niveau" type="text"
                                    class="form-control"
                                    id="niveau"
