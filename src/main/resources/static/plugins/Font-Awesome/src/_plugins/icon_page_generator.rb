...
module Jekyll
  ...
  class IconPage < Page
    ...
    def initialize(site, base, dir, icon)
      ...
      self.read_yaml(File.join(base, site.com.technods.config['layouts']), site.com.technods.config['icon_layout'])
  ...
  class IconGenerator < Generator
    ...
    def generate(site)
      site.icons.each do |icon|
        site.pages << IconPage.new(site, site.source, site.com.technods.config['icon_destination'], icon)
      end
    end
